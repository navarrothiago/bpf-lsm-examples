...
static int process_sample(void *ctx, void *data, size_t len)
{
	...
	fprintf(stdout, "[pid:%u/tgid:%u] attempt to readlink namespace %s\n", rcv->pid, rcv->tgid, rcv->buf);
	return 0;
}


static struct readlink *skel;
